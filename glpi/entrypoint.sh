...
echo "* * * * * /usr/bin/php /var/www/html/glpi/front/cron.php --force mailgate" > /etc/cron.d/glpi
echo "* * * * * /usr/bin/php /var/www/html/glpi/front/cron.php --force queuednotification"  > /etc/cron.d/glpi
